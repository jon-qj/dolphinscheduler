...
<template>
  <div class="flinkx-model">
    <m-list-box>
      ...
      <div slot="content">
        <el-radio-group size="small" v-model="deployMode">
          ...
          <!--          <el-radio :label="'standalone'" :disabled="true"></el-radio>-->
          <!--          <el-radio :label="'yarn'" :disabled="true"></el-radio>-->
          <!--          <el-radio :label="'yarnPer'" :disabled="true"></el-radio>-->
        </el-radio-group>
      </div>
    </m-list-box>
    <m-list-box>
    ...
    <template v-if="!enable">
      ...
      <m-list-box>
        ...
        <div slot="content">
          <label class="label-box">
            <div style="padding-top: 5px;">
              <el-switch v-model="sqlStatement" @change="_onSqlStatementSwitch" :disabled="isDetails"></el-switch>
            </div>
          </label>
        </div>
      </m-list-box>
      <template v-if="sqlStatement">
        <m-list-box>
        ...
        <m-list-box>
          ...
          <div slot="content">
            <el-input
              ...
              :disabled="isDetails"
              v-model="sourceTable"
              :placeholder="$t('Please enter source table')"
              autocomplete="off">
            </el-input>
          </div>
        </m-list-box>
      ...
      <m-list-box>
        ...
        <div slot="content">
          <!--          <m-select-input v-model="writeMode" :list="['INSERT','UPDATE']">-->
          <!--          </m-select-input>-->
          <el-select
            size="small"
            style="width: 130px;"
            v-model="writeMode"
            @change="_onWriteModeChange"
            :disabled="isDetails">
            <el-option
      ...
      <template v-if="writeMode==='UPDATE'">
        <m-list-box>
      ...
      <m-list-box>
        ...
        <div slot="content">
          <el-radio-group v-model="polling" @change="_initIncreParams">
            <el-radio :label="false" :disabled="isDetails">{{ $t('Full Volume Sync') }}</el-radio>
            <el-radio :label="true" :disabled="isDetails">{{ $t('Incremental Sync') }}</el-radio>
          </el-radio-group>
        </div>
      </m-list-box>
      ...
      <m-list-box>
        ...
        <div slot="content">
          <label class="label-box">
            <div style="padding-top: 5px;">
              <el-switch size="small" v-model="split" @change="_onSplitPkSwitch" :disabled="isDetails"></el-switch>
            </div>
          </label>
        </div>
      </m-list-box>
      <template v-if="split">
        <m-list-box>
          ...
          <div slot="content">
            <el-select ref="clearFlinkxSelect"
                       style="width: 160px;"
                       :disabled="isDetails"
                       @change="_onSplitPkChange"
                       v-model="splitPk">
              <el-option
                v-for="city in sourceColumns"
                :key="city.name"
      ...
      <m-list-box>
        ...
        <div slot="content">
          <label class="label-box">
            <el-radio-group v-model="stream">
              <el-radio :label="false" :disabled="isDetails">{{ $t('Offline Sync') }}</el-radio>
              <el-radio :label="true" :disabled="true">{{ $t('Realtime Sync') }}</el-radio>
            </el-radio-group>
          </label>
        </div>
      </m-list-box>
      <m-list-box>
        ...
        <div slot="content">
          <label class="label-box">
            <div style="padding-top: 5px;">
              <el-switch v-model="restore" @change="_onRestoreSwitch" :disabled="isDetails"></el-switch>
            </div>
          </label>
        </div>
      </m-list-box>
        ...
        <m-list-box>
          ...
          <div slot="content">
            <el-select style="width: 160px;"
                       :disabled="isDetails"
                       @change="_onRestoreColumnNameChange"
    ...
    <el-dialog
      ...
      append-to-body="true"
      width="80%">
      <m-script-box :item="item" @getSriptBoxValue="getScriptBoxValue" @closeAble="closeAble"></m-script-box>
    </el-dialog>
  </div>
</template>
    ...
    created () {
      ...
      if (!_.isEmpty(o)) {
        ...
        if (o.params.customConfig === 0) {
          ...
          this.stream = o.params.stream || false
          this.restore = o.params.restore || false
          ...
          this.split = o.params.split || false
          this.jobSpeedChannel = o.params.jobSpeedChannel || 1
          this.sqlStatement = o.params.sqlStatement || false
