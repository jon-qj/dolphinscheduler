...
export default {
  ...
  'Sync Mode': 'Sync Mode',
  'Full Volume Sync': 'Full Volume',
  'Incremental Sync': 'Incremental',
  'Polling Interval': 'Polling Interval',
  'Polling Interval Tips': 'seconds',
  'Incremental Column': 'Incremental Column',
  'Please enter the incremental column(String Or Int)':'Please enter the incremental column(String Or Int)',
  'Start Location': 'Start Location',
  'Please enter the start location of incremental column(optional)':'Please enter the start location of incremental column(optional)',
  'Please choose a Incremental Column(required)':'Please choose a Incremental Column(required)',
  'Unique Index': 'Unique Index',
  'Please choose a Unique Index(required)': 'Please choose a Unique Index(required)',
  'POSTGRESQL does not support UPDATE temporarily': 'POSTGRESQL does not support UPDATE temporarily',
  'Sync Type': 'Sync Type',
  'Offline Sync': 'Offline',
  'Realtime Sync': 'Realtime',
  'Checkpoint Num': 'num for checkpoint',
  'max row num for checkpoint': 'max row num for checkpoint，init 0',
  'Resume From Break Point': 'Resume From Break Point',
  'Resume Column Name': 'Resume Column Name',
  'Please choose a Resume Column(required)': 'Please choose a Resume Column(required)',
  Use: 'start using',
  UNUse: 'stop using',
  'Column Name': 'Restore Column Name',
  ...
  'Use SplitPk': 'use splitPk',
  'SplitPk Column': 'splitPk column',
  ...
  'If you use SplitPk,please be sure the job channel is bigger than 1':'If you use SplitPk,please be sure the job channel is bigger than 1',
  'Please be sure the batch size is not smaller than 1': 'Please be sure the batch size is not smaller than 1',
  TargetDataBase: 'target database',
  TargetTable: 'target table',
  TargetColumn: 'target column',
  'Write Mode': 'write mode',
  'Please enter the table of source': 'Please enter the table of source',
  'Please enter the table of target': 'Please enter the table of target',
  'Please enter the column name of source table': 'Please enter the column name of source table',
  'Please choose a datasource(required)': 'Please choose a datasource(required)',
  'Please enter a table(required)': 'Please enter a table(required)',
  'Please enter a Source Table(required)': 'Please enter a Source Table(required)',
  'Please enter a Target Table(required)': 'Please enter a Target Table(required)',
  'Batch Size': 'batchSize',
  SpeedByte: 'speed(byte count)',
  SpeedChannel: 'speed(channel count)',
