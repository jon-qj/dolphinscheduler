...
export default {
  ...
  'Polling Interval Tips': '秒',
  'Incremental Column': '增量字段',
  'Please enter the incremental column(String Or Int)': '请输入增量字段(string类型或int类型)',
  'Start Location': '起始位置',
  'Please enter the start location of incremental column(optional)': '请输入增量字段起始位置(可选)',
  'Please choose a Incremental Column(required)': '请选择增量字段(必需)',
  'Unique Index': '唯一索引',
  'Please choose a Unique Index(required)': '请选择唯一索引(必需)',
  'POSTGRESQL does not support UPDATE temporarily': 'POSTGRESQL暂不支持UPDATE写入模式',
  'Sync Type': '同步类型',
  'Offline Sync': '离线',
  'Realtime Sync': '实时',
  'Checkpoint Num': 'checkpoint条数',
  'max row num for checkpoint': '触发checkpoint数据条数，默认 0',
  'Please enter description': '请输入描述',
  'Number of failed retries': '失败重试次数',
  'Resume From Break Point': '断点续传',
  'Resume Column Name': '断点续传字段名',
  'Please choose a Resume Column(required)': '请选择断点续传字段(必需)',
  Use: '启用',
  UNUse: '禁用',
  'Column Name': '断点续传列名',
  Times: '次',
  ...
  'If you use SplitPk,please be sure the job channel is bigger than 1':'如果设置切分主键，确保任务并发数大于1',
  'Please be sure the batch size is not smaller than 1': '请确认批量提交数不小于1',
  TargetDataBase: '目标库',
  TargetTable: '目标表',
  TargetColumn: '目标列',
  'Write Mode': '写入模式',
  'Please enter the table of source': '请输入源表',
  'Please enter the table of target': '请输入目标表名',
  'Please enter the column name of source table': '请输入源表中字段名',
  'Please choose a datasource(required)': '请选择源库(必填)',
  'Please enter a table(required)': '请输入表名(必填)',
  'Please enter a Source Table(required)': '请输入源表(必填)',
  'Please enter a Target Table(required)': '请输入目标表(必填)',
  'Batch Size': '批量提交',
  SpeedByte: '限流(字节数)',
  SpeedChannel: '任务并发数',
  '1 means unlimited': '1代表不限制',
  SpeedRecord: '限流(记录数)',
