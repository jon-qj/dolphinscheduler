    ...
    public boolean checkParameters() {
        if (customConfig == Flag.NO.ordinal()) {
            if (sqlStatement) {
                return dataSource != 0
                        && dataTarget != 0
                        && org.apache.commons.lang.StringUtils.isNotEmpty(customSql)
                        && org.apache.commons.lang.StringUtils.isNotEmpty(targetColumns.toString())
                        && org.apache.commons.lang.StringUtils.isNotEmpty(targetTable);
            } else {
                return dataSource != 0
                        && dataTarget != 0
                        && org.apache.commons.lang.StringUtils.isNotEmpty(sourceColumns.toString())
                        && org.apache.commons.lang.StringUtils.isNotEmpty(sourceTable)
                        && org.apache.commons.lang.StringUtils.isNotEmpty(targetColumns.toString())
                        && org.apache.commons.lang.StringUtils.isNotEmpty(targetTable);
            }
        } else {
